...
describe('romajiToHiragana', () => {
  test('basic', () => {
    ...
    expect(Nconv.romajiToHiragana('kwakwikwukwekwo')).toBe('くぁくぃくぅくぇくぉ')
    expect(Nconv.romajiToHiragana('gwagwigwugwegwo')).toBe('ぐぁぐぃぐぅぐぇぐぉ')
    ...
    expect(Nconv.romajiToHiragana('twatwitwutwetwo')).toBe('とぁとぃとぅとぇとぉ')
    expect(Nconv.romajiToHiragana('dwadwidwudwedwo')).toBe('どぁどぃどぅどぇどぉ')
    ...
    expect(Nconv.romajiToHiragana('hwahwihwehwo')).toBe('ふぁふぃふぇふぉ')
    ...
    expect(Nconv.romajiToHiragana('fyafyufyo')).toBe('ふゃふゅふょ')
    ...
    expect(Nconv.romajiToHiragana('whawhiwhuwhewho')).toBe('うぁうぃううぇうぉ')
  ...
  test('double consonant', () => {
    ...
    expect(Nconv.romajiToHiragana('kkwakkwikkwukkwekkwo')).toBe('っくぁっくぃっくぅっくぇっくぉ')
    expect(Nconv.romajiToHiragana('ggwaggwiggwuggweggwo')).toBe('っぐぁっぐぃっぐぅっぐぇっぐぉ')
    ...
    expect(Nconv.romajiToHiragana('ttwattwittwuttwettwo')).toBe('っとぁっとぃっとぅっとぇっとぉ')
    expect(Nconv.romajiToHiragana('ddwaddwiddwuddweddwo')).toBe('っどぁっどぃっどぅっどぇっどぉ')
    ...
    expect(Nconv.romajiToHiragana('hhwahhwihhwehhwo')).toBe('っふぁっふぃっふぇっふぉ')
    ...
    expect(Nconv.romajiToHiragana('ffyaffyuffyo')).toBe('っふゃっふゅっふょ')
    ...
    expect(Nconv.romajiToHiragana('wwhawwhiwwhuwwhewwho')).toBe('っうぁっうぃっうっうぇっうぉ')
...
describe('romajiToZenKata', () => {
  test('basic', () => {
    ...
    expect(Nconv.romajiToZenKata('kwakwikwukwekwo')).toBe('クァクィクゥクェクォ')
    expect(Nconv.romajiToZenKata('gwagwigwugwegwo')).toBe('グァグィグゥグェグォ')
    ...
    expect(Nconv.romajiToZenKata('twatwitwutwetwo')).toBe('トァトィトゥトェトォ')
    expect(Nconv.romajiToZenKata('dwadwidwudwedwo')).toBe('ドァドィドゥドェドォ')
    ...
    expect(Nconv.romajiToZenKata('hwahwihwehwo')).toBe('ファフィフェフォ')
    ...
    expect(Nconv.romajiToZenKata('fyafyufyo')).toBe('フャフュフョ')
    ...
    expect(Nconv.romajiToZenKata('whawhiwhuwhewho')).toBe('ウァウィウウェウォ')
  ...
  test('double consonant', () => {
    ...
    expect(Nconv.romajiToZenKata('kkwakkwikkwukkwekkwo')).toBe('ックァックィックゥックェックォ')
    expect(Nconv.romajiToZenKata('ggwaggwiggwuggweggwo')).toBe('ッグァッグィッグゥッグェッグォ')
    ...
    expect(Nconv.romajiToZenKata('ttwattwittwuttwettwo')).toBe('ットァットィットゥットェットォ')
    expect(Nconv.romajiToZenKata('ddwaddwiddwuddweddwo')).toBe('ッドァッドィッドゥッドェッドォ')
    ...
    expect(Nconv.romajiToZenKata('hhwahhwihhwehhwo')).toBe('ッファッフィッフェッフォ')
    ...
    expect(Nconv.romajiToZenKata('ffyaffyuffyo')).toBe('ッフャッフュッフョ')
    ...
    expect(Nconv.romajiToZenKata('wwhawwhiwwhuwwhewwho')).toBe('ッウァッウィッウッウェッウォ')
...
describe('romajiToHanKata', () => {
  test('basic', () => {
    ...
    expect(Nconv.romajiToHanKata('kwakwikwukwekwo')).toBe('ｸｧｸｨｸｩｸｪｸｫ')
    expect(Nconv.romajiToHanKata('gwagwigwugwegwo')).toBe('ｸﾞｧｸﾞｨｸﾞｩｸﾞｪｸﾞｫ')
    ...
    expect(Nconv.romajiToHanKata('twatwitwutwetwo')).toBe('ﾄｧﾄｨﾄｩﾄｪﾄｫ')
    expect(Nconv.romajiToHanKata('dwadwidwudwedwo')).toBe('ﾄﾞｧﾄﾞｨﾄﾞｩﾄﾞｪﾄﾞｫ')
    ...
    expect(Nconv.romajiToHanKata('hwahwihwehwo')).toBe('ﾌｧﾌｨﾌｪﾌｫ')
    ...
    expect(Nconv.romajiToHanKata('fyafyufyo')).toBe('ﾌｬﾌｭﾌｮ')
    ...
    expect(Nconv.romajiToHanKata('whawhiwhuwhewho')).toBe('ｳｧｳｨｳｳｪｳｫ')
  ...
  test('double consonant', () => {
    ...
    expect(Nconv.romajiToHanKata('kkwakkwikkwukkwekkwo')).toBe('ｯｸｧｯｸｨｯｸｩｯｸｪｯｸｫ')
    expect(Nconv.romajiToHanKata('ggwaggwiggwuggweggwo')).toBe('ｯｸﾞｧｯｸﾞｨｯｸﾞｩｯｸﾞｪｯｸﾞｫ')
    ...
    expect(Nconv.romajiToHanKata('ttwattwittwuttwettwo')).toBe('ｯﾄｧｯﾄｨｯﾄｩｯﾄｪｯﾄｫ')
    expect(Nconv.romajiToHanKata('ddwaddwiddwuddweddwo')).toBe('ｯﾄﾞｧｯﾄﾞｨｯﾄﾞｩｯﾄﾞｪｯﾄﾞｫ')
    ...
    expect(Nconv.romajiToHanKata('hhwahhwihhwehhwo')).toBe('ｯﾌｧｯﾌｨｯﾌｪｯﾌｫ')
    ...
    expect(Nconv.romajiToHanKata('ffyaffyuffyo')).toBe('ｯﾌｬｯﾌｭｯﾌｮ')
    ...
    expect(Nconv.romajiToHanKata('wwhawwhiwwhuwwhewwho')).toBe('ｯｳｧｯｳｨｯｳｯｳｪｯｳｫ')
