...
describe('romajiToZenKata', () => {
  test('basic', () => {
    ...
    expect(Nconv.romajiToZenKata('wawo')).toBe('ワヲ')
    ...
    expect(Nconv.romajiToZenKata('shi')).toBe('シ')
  ...
  test('double consonant', () => {
    ...
    expect(Nconv.romajiToZenKata('wwawwo')).toBe('ッワッヲ')
    ...
    expect(Nconv.romajiToZenKata('sshi')).toBe('ッシ')
...
describe('romajiToHanKata', () => {
  test('basic', () => {
    ...
    expect(Nconv.romajiToHanKata('wawo')).toBe('ﾜｦ')
    ...
    expect(Nconv.romajiToHanKata('shi')).toBe('ｼ')
  ...
  test('double consonant', () => {
    ...
    expect(Nconv.romajiToHanKata('wwawwo')).toBe('ｯﾜｯｦ')
    ...
    expect(Nconv.romajiToHanKata('sshi')).toBe('ｯｼ')
